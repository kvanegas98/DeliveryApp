...
class RegisterController extends GetxController {
  ...
  void register() async {
    ...
    if (isValidForm(email, name, lastname, phone, password, confirmPassword)) {
      ...
      final Map<String, dynamic> decodedResp = response.body;

      print('RESPONSE****: ${decodedResp}');

      if (decodedResp.containsKey('success') == true) {
        Get.snackbar('', 'Guardado correctamente');
      } else {
        Get.snackbar('', 'Ha ocurrido un error');
      }
    }
  }
